...

{
  age.secrets.credentials-conduit-config.file =
    ../../../secrets/credentials/conduit-config.age;
  ...
  age.secrets.credentials-mautrix-telegram-config.file =
    ../../../secrets/credentials/mautrix-telegram-config.age;
  ...
  age.secrets.credentials-coturn-secret.file =
    ../../../secrets/credentials/coturn-secret.age;
  ...
  services.coturn = {
    ...
    cert =
      "${config.security.acme.certs."turn.cofob.dev".directory}/fullchain.pem";
    pkey =
      "${config.security.acme.certs."turn.cofob.dev".directory}/privkey.pem";
    extraConfig = ''
  ...
  security.acme.certs."turn.cofob.dev" = { reloadServices = [ "coturn" ]; };
